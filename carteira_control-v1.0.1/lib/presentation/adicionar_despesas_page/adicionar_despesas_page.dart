...
class AdicionarDespesasPage extends StatefulWidget {
  const AdicionarDespesasPage({Key? key})
      : super(
          key: key,
        );

  @override
  AdicionarDespesasPageState createState() => AdicionarDespesasPageState();
}

class AdicionarDespesasPageState extends State<AdicionarDespesasPage>
    with AutomaticKeepAliveClientMixin<AdicionarDespesasPage> {
